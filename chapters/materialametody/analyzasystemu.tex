...
\emph{Prostorovo-fázový diagram} (\emph{pf-diagram}) zkoumá chování paprsků v blízkém okolí osy $y$.
...
Na příkladu již několikrát zmíněného světlovodu to znamená, že čím větší je výstupní otvor světlovodu, tím menší rozptyl paprsků budeme pozorovat. To je patrné i na následujících obrázcích.
