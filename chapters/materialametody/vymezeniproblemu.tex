...
\singleimage{
    \image[scale=0.15]{vymezeniproblemu_absorber.png}{Příklad dokonalé absorbce na cloně (šedá) s bodovým zdrojem světla a několika znázorněnými paprsky (červená)}
}
